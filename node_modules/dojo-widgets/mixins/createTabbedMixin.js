(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'maquette/maquette', 'dojo-compose/mixins/createDestroyable', 'dojo-core/WeakMap', './createContainerMixin'], factory);
    }
        ...
        mixin: {
            ...
            getChildrenNodes: function () {
                ...
                tabbed.children.forEach(function (tab, key) {
                    ...
                    tabs.push(maquette_1.h(tabbed.tagNames.tab, { key: tab, classes: { active: isActiveTab } }, getTabChildVNode(tab)));
                });
