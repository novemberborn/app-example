(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", 'maquette/maquette', 'dojo-compose/mixins/createDestroyable', 'dojo-compose/mixins/createEvented', 'dojo-compose/mixins/createStateful', 'dojo-core/Promise', 'dojo-core/WeakMap', './mixins/createRenderable'], factory);
    }
    ...
    var createDijit = createRenderable_1.default
        ...
        initialize: function (instance, options) {
            ...
            if (options) {
                ...
                if (typeof Ctor === 'string') {
                    resolveCtor(options.Ctor).then(function (Ctor) {
                        dijitData.Ctor = Ctor;
                    }, function (error) {
                        instance.emit({
                            type: 'error',
        ...
        initialize: function (instance) {
            instance.own(instance.on('statechange', function (event) {
                ...
                if (Ctor || params) {
                    var dijitData_1 = dijitDataWeakMap.get(instance);
                    if (!dijitData_1.dijitWidget) {
                        if (Ctor) {
                            resolveCtor(Ctor).then(function (Ctor) {
                                dijitData_1.Ctor = Ctor;
                            }, function (error) {
                                instance.emit({
                                    type: 'error',
                                    error: error,
...
//# sourceMappingURL=_debug/createDijit.js.map