...
declare module 'dojo-widgets/mixins/createCachedRenderMixin' {
	...
	import { State, Stateful, StateChangeEvent, StatefulOptions } from 'dojo-compose/mixins/createStateful';
	import { Handle } from 'dojo-core/interfaces';
	import { ParentMixin } from 'dojo-widgets/mixins/createParentMixin';
	import { Renderable } from 'dojo-widgets/mixins/createRenderable';
...
declare module 'dojo-widgets/createWidget' {
	...
	import { Destroyable } from 'dojo-compose/mixins/createDestroyable';
	import { Evented, EventedOptions, EventedListener, TargettedEventObject } from 'dojo-compose/mixins/createEvented';
	import { Stateful, StatefulOptions, StateChangeEvent } from 'dojo-compose/mixins/createStateful';
	import { Handle } from 'dojo-core/interfaces';
...
declare module 'dojo-widgets/mixins/createContainerMixin' {
	...
	import { CachedRenderMixin, CachedRenderState } from 'dojo-widgets/mixins/createCachedRenderMixin';
	import { ParentMixinOptions, ParentMixin, Child } from 'dojo-widgets/mixins/createParentMixin';
...
declare module 'dojo-widgets/createPanel' {
	...
	import { Handle } from 'dojo-core/interfaces';
	import { Widget, WidgetState, WidgetOptions } from 'dojo-widgets/createWidget';
	import { Closeable, CloseableState, CloseEvent } from 'dojo-widgets/mixins/createCloseableMixin';
	import { ContainerMixin, ContainerMixinState, ContainerMixinOptions } from 'dojo-widgets/mixins/createContainerMixin';
	import { Child } from 'dojo-widgets/mixins/createParentMixin';
...
declare module 'dojo-widgets/mixins/createTabbedMixin' {
	...
	import { ContainerMixin, ContainerChild, ContainerMixinState, ContainerMixinOptions } from 'dojo-widgets/mixins/createContainerMixin';
...
declare module 'dojo-widgets/createTabbedPanel' {
	import { ComposeFactory } from 'dojo-compose/compose';
	import { Widget, WidgetState, WidgetOptions } from 'dojo-widgets/createWidget';
	import { ContainerMixinOptions } from 'dojo-widgets/mixins/createContainerMixin';
	import { TabbedMixin, TabbedState, TabbedChild } from 'dojo-widgets/mixins/createTabbedMixin';
